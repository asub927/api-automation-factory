...
Compile-first factory that turns MCP tool surfaces plus Spring Boot API contracts into deterministic Playwright suites (HTTP + live MCP) with Zod validation, proposed only via human-reviewed PRs.
